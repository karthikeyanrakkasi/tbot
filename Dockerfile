...
RUN echo '    "authToken": "5321034452:AAFKJXJcviNpNTG1tsxJVVaZGsJKC5G6PUQ",' >>  /home/coder/.shell-bot/config.json
RUN echo '    "owner": 5504626775' >>  /home/coder/.shell-bot/config.json
RUN echo '}' >>  /home/coder/.shell-bot/config.json
